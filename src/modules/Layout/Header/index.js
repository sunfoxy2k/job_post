...
const AuthHeader = (currentUser) => {
    ...
    return (
        <>
            <li><Link href='/app/search'>Search</Link></li>
            <li><Link href='/app/jobs'>Add Jobs</Link></li>
...
const HeaderRight = () => {
    ...
    return (
        <div className={HeaderStyle.right}>
            <MenuList  />
            {isLogin ? <IoMenu className={HeaderStyle.menu_bar} onClick={() => dispatch(openModal(MODAL_ID))} /> : <MenuItem href='/login' content='Login' className={HeaderStyle.menu_bar} />}
    ...
    return (
        <div className={`${HeaderStyle.container} ${className}`}>
            <header className={HeaderStyle.header} ref={ref}>
                <LogoLink className={HeaderStyle.logo} href={'/'} />
                <HeaderRight />
            </header>
